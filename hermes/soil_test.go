...
func TestSoilCompressionOverTime(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotNewBD, gotNewSumke, gotAirPoreVolume, gotMineralisationFactor := SoilCompressionOverTime(tt.args.sumke, tt.args.startBD, tt.args.currentBD, tt.args.cOrg, tt.args.fc, tt.args.layerDepth, tt.args.precip, false)
